...
export const PRODUCT_SCOPE = Object.freeze([
  ...
  { id: 'ADMIN', normative: true, coverageStatus: 'COVERED_BY_REQUIREMENT', requirementIds: ['FZ-REQ-ADMIN-001', 'FZ-REQ-ADMIN-002', 'FZ-REQ-ADMIN-003'] },
...
export const PARENT_MODELS = Object.freeze([
  ...
  { capability: 'ADMIN', requiredDepths: ['FOUNDATION', 'WORKFLOW', 'OFFER_WORKFLOW'] },
