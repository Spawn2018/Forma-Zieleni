...
export const PRODUCT_SCOPE = Object.freeze([
  ...
  { id: 'ATLAS', normative: true, coverageStatus: 'COVERED_BY_REQUIREMENT', requirementIds: ['FZ-REQ-ATLAS-001', 'FZ-REQ-ATLAS-002', 'FZ-REQ-ATLAS-003'] },
...
export const PARENT_MODELS = Object.freeze([
  ...
  { capability: 'ATLAS', requiredDepths: ['FOUNDATION', 'BOUNDARY', 'DOMAIN'] },
