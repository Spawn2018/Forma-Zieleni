...
export const PRODUCT_SCOPE = Object.freeze([
  ...
  { id: 'ADMIN', normative: true, coverageStatus: 'COVERED_BY_REQUIREMENT', requirementIds: ['FZ-REQ-ADMIN-001', 'FZ-REQ-ADMIN-002'] },
  ...
  { id: 'SITEINTEL', normative: true, coverageStatus: 'COVERED_BY_REQUIREMENT', requirementIds: ['FZ-REQ-SITEINTEL-001', 'FZ-REQ-SITEINTEL-002'] },
  { id: 'ATLAS', normative: true, coverageStatus: 'COVERED_BY_REQUIREMENT', requirementIds: ['FZ-REQ-ATLAS-001', 'FZ-REQ-ATLAS-002', 'FZ-REQ-ATLAS-003', 'FZ-REQ-ATLAS-004'] },
...
export const PARENT_MODELS = Object.freeze([
  ...
  { capability: 'SITEINTEL', requiredDepths: ['BOUNDARY', 'RULES'] },
  { capability: 'ATLAS', requiredDepths: ['FOUNDATION', 'BOUNDARY', 'DOMAIN', 'RUNTIME'] },
  { capability: 'SKETCHUP', requiredDepths: ['BOUNDARY', 'INTEGRATION'] },
  { capability: 'ADMIN', requiredDepths: ['FOUNDATION', 'WORKFLOW'] },
