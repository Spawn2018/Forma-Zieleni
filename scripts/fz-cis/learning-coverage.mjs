...
export const LEARNING_SUBJECTS = Object.freeze([
  ...
  subject({
    ...
    effectMethod: 'DETERMINISTIC_REPLAY',
    durableControlType: 'DOMAIN_RULE',
    signalOwner: 'capacity-domain',
    provenance: 'domain-fixture',
    observationType: 'capacity-refusal',
    materialityRule: 'a promised date outside capacity was accepted or a capacity write lacked authz',
    humanApprovalRule: 'calendar SaaS and live Google accounts stay Owner-gated',
    automationLimit: 'does not book external calendars or invent availability',
    signals: [sig('outside-capacity-refusal', 'technical', 'CONTRACT_ONLY')],
    productionDependency: 'staff capacity UI after CAPACITY-DOMAIN',
    activationCondition: 'CAPACITY-DOMAIN domain tests, then staff UI when shipped',
    nextActivation: 'WAITING_FOR_PRODUCT_RUNTIME',
  }),
  subject({
    id: 'HOSTING',
