...
export type Capability = LeadCapability | OpportunityCapability | OfferCapability | ContractCapability | ProjectCapability | FileCapability | MilestoneCapability | ContentCapability | GrowthCapability;
