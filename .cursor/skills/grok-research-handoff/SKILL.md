...
- Cursor local Agent **cannot** programmatically invoke a named Grok Bot and receive a return today — produce the brief for **manual owner transfer**
...
- What Cursor local already concluded (to challenge or extend):
...
- What would falsify the Cursor local conclusion
...
- Optional Cursor CloudAgent **only if** owner/Grok explicitly enables it for this task and Forma Zieleni gates are respected (no silent branch/PR override of main-only)
...
- Modify Forma Zieleni Canon or repository without going back through Cursor local + gates
- Choose framework / hosting / DB / ORM / storage / payment provider
- Push, production, DNS, secrets, destructive data ops
- Build custom Cursor→Grok bridges or control-ui automation as the delivery path
...
### Disagreements with Cursor local conclusion
### Recommended next action for Cursor local (research-only; not implementation auth)
