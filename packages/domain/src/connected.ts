...
export const CONNECTIVITY: Array<{ surface: string; state: string; reason: string }> = [
  ...
  ['Admin', 'PROJECTION', 'apps/admin is a React Router application with staff lead, opportunity, offer, contract, project, and file metadata list/create against Core API. No signing ceremony and no payment UI.'],
  ...
  ['Plant Atlas', 'PROJECTION', 'WWW Atlas route projects approved plant identities with taxonomic citations. Cultivation advice stays off.'],
  ...
  ['Garden OS', 'LOCAL_BY_DESIGN', 'Domain garden record links a delivered project. Twin runtime and twin database stay later.'],
  ['SketchUp', 'LOCAL_BY_DESIGN', 'Model-to-project id mapping exists. Plugin runtime install stays later.'],
