...
export const CONNECTIVITY: Array<{ surface: string; state: string; reason: string }> = [
  ...
  ['Admin', 'FUTURE_DEPENDENCY', 'apps/admin is a boundary note until a React Router app exists.'],
  ['Portal', 'FUTURE_DEPENDENCY', 'apps/portal is a boundary note. Customer scope is enforced in this module.'],
