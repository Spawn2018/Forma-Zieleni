...
export const CONNECTIVITY: Array<{ surface: string; state: string; reason: string }> = [
  ...
  ['Admin', 'PROJECTION', 'apps/admin is a React Router application with staff lead, offer, and contract list/create against Core API. No signing ceremony and no payment UI.'],
