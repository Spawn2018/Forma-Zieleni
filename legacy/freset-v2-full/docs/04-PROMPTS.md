...
> **AKTUALIZACJA F-RESET — 2026-09-20:** Prompty F0–F33 są LEGACY/INPUT. Nowa kolejność to A Security → B API Contract → C Core → D Products. Nie uruchamiać ich sekwencyjnie według starego planu.  
