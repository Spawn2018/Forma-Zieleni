...
> **AKTUALIZACJA F-RESET — 2026-09-20:** Specyfikacja WWW jest wymaganiem ETAPU D. Nie steruje już kolejnością wdrożenia. WWW ma być Sales Application i korzystać wyłącznie z Core API/typed client.  
...
Wersja 1.0, 16.09.2026. Dokument jest wymaganiem produktu WWW dla ETAPU D; nie jest nadrzędnym źródłem prawdy dla architektury ani roadmapy. Oznaczenia `[E1]`–`[E11]` odsyłają do tabeli dowodów w §4. Wszystko w `{{…}}` to dane, które musi dostarczyć właściciel (lista w §16). Nie wolno ich zgadywać.
...
| E37 | Cloudflare, plan Free (przeglądy 2026) | Workers: 100 000 żądań dziennie; R2: 10 GB, 1 mln operacji A i 10 mln B miesięcznie, bez opłat za ruch wychodzący; Pages: 500 buildów miesięcznie. | Historyczny wariant wyglądał na możliwy w planie darmowym; NIE jest to wybór stacku. Aktualny hosting/compute/DB/storage wybieramy w ETAPIE A po ponownym sprawdzeniu limitów i testach. | Opracowania zewnętrzne; limity D1, Turnstile i Access do potwierdzenia w cenniku. |
...
| E39 | Meta-analizy przypomnień o wizytach (28 badań; BMJ Open 2016, 21 badań) oraz RCT Am J Med 2010 | Przypomnienia podnoszą obecność (iloraz szans 1,62) i obniżają nieobecności o ok. 25% (21% → 15%); telefon od człowieka skuteczniejszy niż automat (13,6% wobec 17,3%; brak przypomnienia 23,1%). | Potwierdzenie po rezerwacji, przypomnienia 24 h i 2 h, przyciski Potwierdzam i Zmieniam termin, lista oczekujących (M43, A30–A32). | Dane z ochrony zdrowia; przeniesienie na konsultacje ogrodowe to założenie. |
| E40 | Kivetz, Urminsky, Zheng 2006 (JMR 43(1)); Nunes i Drèze 2006 (JCR 32(4)) | Bliskość celu przyspiesza działanie; darowany postęp podniósł realizację kart z 19% do 34%. | Uczciwy postęp w quizie, formularzu, portalu i ścieżce opinii (M44). | Programy lojalnościowe; u nas postęp musi być prawdziwy. |
| E41 | Schmitt, Skiera, Van den Bulte 2011 (Journal of Marketing 75(1)) | Klienci z polecenia: wartość życiowa wyższa o 16–25%, odejścia wolniejsze o ok. 18%, efekt zależny od segmentu. | Selektywny program poleceń po ankiecie 4–5, nagroda dwustronna, kwartalna weryfikacja (M45, A33–A34). | Jeden bank w Niemczech; wielkość efektu może się różnić. |
| E42 | Dokumentacja Chrome, Speculation Rules (akt. I 2026) | Prerender daje niemal zerowy LCP, mniejszy CLS i lepszy INP; obsługa: Chrome i Edge od 109, Firefox nie, Safari za flagą. | Prefetch linków wewnętrznych, prerender 3 ścieżek, wykluczenia i pomiar po aktywacji (M46). | Działa tylko dla części przeglądarek; nie zastępuje optymalizacji. |
| E43 | SketchUp 2026, dokumentacja pomocy (2026) | Pasek współpracy pozwala udostępnić model prywatnym zaproszeniem lub publicznym linkiem; odbiorca ogląda go w przeglądarce, mierzy, komentuje i widzi zmiany na żywo; wymagany zapis w Trimble Connect, który jest w każdej subskrypcji z nieograniczoną przestrzenią. | Link do modelu w portalu przy wersji koncepcji (`design_assets.skp_link`), ciężkie pliki poza R2. | Wymaga aktywnej subskrypcji; funkcje nie działają w starszych wersjach SketchUp. |
| E44 | V-Ray 7 for SketchUp, Update 2 (2026) | Wsparcie dla SketchUp 2026; kamery VR w trybie stereo, Chaos Cosmos, renderowanie w chmurze, narzędzia AI do materiałów i poprawy obrazu (beta). | Trzy presety renderów, panorama 360 w portalu, oznaczanie treści AI, znak wodny przed akceptacją. | Materiały producenta i dystrybutora. |
| E45 | Zestawienia wtyczek do SketchUp 2026 (rendair.ai, redraw.pro, myarchitectai.com, blog Trimble) | Najczęściej wskazywane w pracy z terenem i zielenią: Skatter 2 (rozsiewanie roślin), Profile Builder (profile po ścieżce), CleanUp³ i Solid Inspector² (czyszczenie i kontrola), Fredo6 (formy organiczne), Skalp (przekroje), PlaceMaker (kontekst). | Lista wtyczek w `18-SKETCHUP-CLAUDE.md` §3 i standard modelu w §2. | Zestawienia branżowe i marketingowe, ceny orientacyjne. |
| E46 | DORA, „State of AI-assisted Software Development” (2025) i przeglądy branżowe 2026 | AI jest wzmacniaczem istniejącego systemu pracy; w 2024 r. wzrost użycia AI o 25% wiązał się ze spadkiem przepustowości o ok. 1,5% i stabilności o ok. 7,2%, w 2025 r. przepustowość wzrosła, ale stabilność nadal spada; ok. 90% specjalistów używa AI, ok. 30% nie ufa jego kodowi; wąskim gardłem są przegląd, testy i wdrożenie. | Małe zmiany, test albo ręczna kontrola dla każdej zmiany z AI, flagi funkcji, cztery metryki wdrożeń, budżet błędów (`19-PRACOWNIA-IT.md` §1). | Ankieta i korelacje, nie eksperyment; część liczb z opracowań wtórnych. |
| E47 | Land F/X (2026) i Vectorworks Landmark 2026 | Land F/X: ponad 55 tys. roślin weryfikowanych przez ogrodnika, automatyczne ilości, zestawienia, kontrola błędów, kosztorysy, moduł nawodnienia; Landmark 2026: masowa edycja danych roślin i pobieranie danych ze stron szkółek. | Nie kopiujemy bazy; budujemy lokalnie sprawdzony atlas, dostępność i ceny u partnera, kontrolę kompletności projektu i specyfikację PDF (§2). | Materiały producentów. |
| E48 | Expo i EAS (2026) | Expo SDK 57 odpowiada React Native 0.86 (sierpień 2026); Expo i SDK są darmowe, płatne jest EAS; plan darmowy: 15 buildów Android i 15 iOS miesięcznie, 60 min workflow, 1 tys. użytkowników aktualizacji; Expo uznawane za gotowe produkcyjnie. | Jeden kod na iOS i Android, ten sam backend co portal, aktualizacje bez sklepu (`20-APLIKACJA-GARDEN-OS.md` §2). | Limity i ceny producenta mogą się zmienić; kredyty buildów nie przechodzą na kolejny miesiąc. |
| E49 | App Store Connect i Google Play (2026) | DSA wymaga deklaracji statusu przedsiębiorcy, inaczej usunięcie ze sklepu w UE, a dane kontaktowe firmy są publiczne; Google Play: 25 USD jednorazowo, formularz Bezpieczeństwo danych, aktualny target API, od 28.10.2026 nowe zasady dostępu do kontaktów; ok. 1 na 4 zgłoszenia odrzucane przy pierwszym podejściu, głównie przez awarie i prywatność. | Lista blokerów publikacji i konto demo w §3; brak zbędnych uprawnień; plan na dwa podejścia. | Zasady sklepów zmieniają się kilka razy w roku. |
...
| F25 | skuteczność: przypomnienia i odwołania, postęp, polecenia, Speculation Rules | 2 dni |
| F26 | fundament niezawodności: outbox, idempotencja, duplikaty, czas pracy, środowisko testowe | 2–3 dni |
| F27 | portal v3 i pipeline CAD: dostęp ról, harmonogram płatności, wersje wizualizacji, panorama | 2–3 dni |
| F28 | pracownia: API dla wtyczki SketchUp, obmiar i kosztorys, puls zadań, samoobsługa RODO | 2 dni |
| F29 | system pracy pracowni: czas i marża, metryki wdrożeń, dostępność roślin, kontrola kompletności | 2 dni |
| F30 | aplikacja mobilna MVP: Expo, logowanie, zakładka Projekt, push, zgodność ze sklepami | 3–4 tygodnie |
| F31 | GARDEN OS: kalendarz zadań, dziennik, alerty pogodowe, gwarancje, przeglądy | 2 tygodnie |
| F32 | ochrona zakresu i marży: zmiany, decyzje, materiały z projektu | 1 dzień |
| F33 | przepustowość: normy godzinowe, rezerwacje, terminy z kalendarza, tryb awaryjny | 1–2 dni |
