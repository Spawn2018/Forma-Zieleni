...
> **AKTUALIZACJA F-RESET — 2026-09-20:** Garden OS jest ETAPEM D i cyfrowym bliźniakiem ogrodu; mobile skupia task/photo/push, nie klonuje portalu.  
...
- **Backend wspólny:** aplikacja korzysta z tego samego Core API i kontraktu co portal. Konkretny hosting/compute/DB/storage nie jest jeszcze wybrany; Workers/D1/R2 to wyłącznie historyczny kandydat.
