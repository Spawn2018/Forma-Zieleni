...
- Public content/media contracts are not selected. FZ-CMS-1 is OPEN. After a decision, published content is a projection consumed by WWW (and later mobile), not a second business database. See [`../architecture/OWNER-DECISION-PACKET-FZ-CMS-1.md`](../architecture/OWNER-DECISION-PACKET-FZ-CMS-1.md).
