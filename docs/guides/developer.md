...
Deeper approved product work is on MAIN as OPEN slices (the selector names the next one). Owner gates and report-only acceptance stay visible and do not erase that work. Missing binding
